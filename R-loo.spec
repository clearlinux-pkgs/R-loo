...
Version  : 2.5.1
Release  : 55
URL      : https://cran.r-project.org/src/contrib/loo_2.5.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/loo_2.5.1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648152140
