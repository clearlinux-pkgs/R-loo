...
Version  : 2.2.0
Release  : 27
URL      : https://cran.r-project.org/src/contrib/loo_2.2.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/loo_2.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1576779517
